...
peaks = [
    glload(filename="../redefine/Hs_hesc_ctcf.rp1.bed.gz.glb"),
    glload(filename="../redefine/Hs_hesc_ctcf.rp2.bed.gz.glb"),
    glload(filename="../redefine/Hs_hesc_ctcf.rp3.bed.gz.glb"),
    glload(filename="../redefine/Hs_hesc_ctcf.rp4.bed.gz.glb"),
    ]
